  ...
  <div class="site-header no-print">
    <div class="site-header-inner">
      ...
      <div class="download-controls">
        <select class="version-select header-button" aria-label="EntropyLab version"><option value="entropylab-{{VERSION}}.html" selected>v{{VERSION}} (Latest)</option></select>
  ...
  <div class="wrap">
    ...
    <header>
      <div>
        ...
        <h1>EntropyLab — Air-Gapped Bitcoin Calculator</h1>
